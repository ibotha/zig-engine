...
pub fn main() !void {
    ...
    const surface: vk.SurfaceKHR = try instance.createWaylandSurfaceKHR(&vk.WaylandSurfaceCreateInfoKHR{
        .display = @ptrCast(platform_data.display),
        .surface = @ptrCast(platform_data.window.surface),
    }, &vk_allocator.callbacks);
